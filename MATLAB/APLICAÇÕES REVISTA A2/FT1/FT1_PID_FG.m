...
for i=4:nptos,
            ...
            h(i) = real(h0); % store the height for plotting

            erro(i)= real(ref(i) - h(i));
...
%    {***********Regi�o IC-1*****************}
     if ( erro(i)>0  & r(i)>0 ) 
         ...
         mi5 = (-r(i)/Lf + 1)*(-erro(i)/Lf + 1); mi6 = (-erro(i)/Lf + 1)*(r(i)/Lf); mi8 = (erro(i)/Lf)*(-r(i)/Lf + 1); mi9 = (r(i)/Lf)*(erro(i)/Lf); 
...
%      {***********Regi�o IC-2*****************}
      if ( erro(i)<=0  & r(i)<=0) 
         ...
         mi1 = (-r(i)/Lf )*(-erro(i)/Lf); mi2 = (-erro(i)/Lf)*(r(i)/Lf + 1); mi4 = (-r(i)/Lf)*(erro(i)/Lf + 1); mi5 = (r(i)/Lf + 1)*(erro(i)/Lf + 1); 
 ...
 %     {***********Regi�o IC-3*****************}
      if ( erro(i)>0  & r(i)<=0) 
           ...
           mi5 = (-r(i)/Lf + 1)*(-erro(i)/Lf + 1); mi4 = (-erro(i)/Lf + 1)*(r(i)/Lf); mi8 = (erro(i)/Lf)*(-r(i)/Lf + 1); mi7 = (-r(i)/Lf)*(erro(i)/Lf); 
 ...
 %      {***********Regi�o IC-4*****************}
      if ( erro(i)<=0  & r(i)>0)
          ...
          mi5 = (-r(i)/Lf + 1)*(erro(i)/Lf + 1); mi6 = (erro(i)/Lf + 1)*(r(i)/Lf); mi2 = (-erro(i)/Lf)*(-r(i)/Lf + 1); mi3 = (-r(i)/Lf)*(-erro(i)/Lf); 
